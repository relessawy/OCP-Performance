...
oc create -f https://raw.githubusercontent.com/wael2000/OCP-Performance/master/prometheus/prom-configmap.yaml    #mount this configmap at at /etc/prometheus/prometheus.yml  #Scrape rules for prometheus 
